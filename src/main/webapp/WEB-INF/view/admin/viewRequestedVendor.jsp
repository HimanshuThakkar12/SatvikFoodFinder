...
<title>view Requested Vendor</title>
<!-- base:css -->
<link rel="stylesheet"
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="contetCenter">
								<h4 class="card-title text-center ">View Requested Vendor</h4>
							</div>
							<div class="row">
...
badge badge-success badge-pill  -->
														<td><a href="acceptVendor?id=${p.id}"><button
																	class="
																	badge badge-primary badge-pill">Accept</button></a>

															<a href="rejectVendor?id=${p.id}"><button
																	class="badge badge-danger badge-pill">Reject</button></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
