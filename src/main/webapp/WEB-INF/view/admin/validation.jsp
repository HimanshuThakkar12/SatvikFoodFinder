...
<body class="sidebar-light">
	...
	<script src="adminResourses/js/jquery.validate.min.js"></script>
	<script src="adminResourses/js/bootstrap-maxlength.min.js"></script>
	<!-- End plugin js for this page -->
	<!-- Custom js for this page-->
	<script src="adminResourses/js/form-validation.js"></script>
	<script src="adminResourses/js/bt-maxLength.js"></script>
