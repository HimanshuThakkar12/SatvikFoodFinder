...
<title>view block ustomers</title>
<!-- base:css -->
<link rel="stylesheet"
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title text-center">View block Customers</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
													<c:forEach items="${blockedUserList}" var="p" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${p.username}</td>
														<td>${p.email}</td>
														<td>${p.gender}</td>
														<td class="pr-0 text-left"><a href="unBlockUser?id=${p.id}"><button class="badge badge-primary badge-pill">UnBlock</button></a></td>
													</tr>
												</c:forEach>
