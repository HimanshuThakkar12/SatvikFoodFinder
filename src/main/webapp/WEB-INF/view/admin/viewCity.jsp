...
<body class="sidebar-light">
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${viewInfo }" var="i" varStatus="j">
													...
													<tr>
														...
														<td>
														<a href="<c:out value='setUpdateCityInfo?cityId=${i.cityId }' />"> <i class="mdi mdi-pencil lead"></i>
														</a> 
														<a href="/admin/deleteCity/${i.cityId}"> <i
	...
	<script src="<%=request.getContextPath()%>/adminResourses/js/jquery.dataTables.js"></script>
	<script src="<%=request.getContextPath()%>/adminResourses/js/dataTables.bootstrap4.js"></script>
	<!-- End plugin js for this page -->
	<!-- Custom js for this page-->
	<script src="<%=request.getContextPath()%>/adminResourses/js/data-table.js"></script>
