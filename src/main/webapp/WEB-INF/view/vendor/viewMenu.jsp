		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title contetCenter">Menu Information</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${foodMenuList }" var="i" varStatus="j">
													...
													<tr>
														...
														<td><a
															href="<c:out value='setUpdateFoodItem?foodID=${i.foodID }' />">
																<i class="mdi mdi-pencil lead"></i>
														</a> <a href="<c:out value='deleteFoodItem/${i.foodID }' />">
